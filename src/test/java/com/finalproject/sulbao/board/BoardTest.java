...
class BoardTest {
    ...
    private void insertPost(Login john, BoardCategory zzanPost) {
        for (int i = 0; i < 100; i++) {
            PostImage postImage1 = PostImage.createPostImage("post_image");
            PostImage postImage2 = PostImage.createPostImage("post_image");
            List<PostImage> postImages = List.of(postImage1, postImage2);
            String content = """
                    <section>
            ...
            Post post = Post.createPost(john, zzanPost, "Hello, World!", content, postImages);
